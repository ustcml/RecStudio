...
from recstudio.model.module import layers, graphmodule 
...
class LightGCN(basemodel.BaseRetriever):
    ...
    def _init_model(self, train_data):
        ...
        for i in range(self.config['n_layers']):
            self.aggregators.append(graphmodule.LightGCNCombiner(self.embed_dim, self.embed_dim))
        self.LightGCNConv = graphmodule.LightGCNNet_dglnn(self.aggregators)
    ...
    def _set_data_field(self, data):
        data.use_field = [data.fuid, data.fiid, data.frating, 'user_hist']
    ...
    def update_encoders(self):
        ...
        all_embeddings = self.LightGCNConv(self.adj_mat, embeddings)
